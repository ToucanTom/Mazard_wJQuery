function move() {
  ...
  if (
    ...
    $(
      '#' + currentPlayer.rowLocation + '-' + currentPlayer.colLocation
    ).empty();
  else {
    $('#' + currentPlayer.rowLocation + '-' + currentPlayer.colLocation).html(
  ...
  updateStats();
  if (!chest)
    currentGameBoard[currentPlayer.rowLocation][
...
function move2() {
  ...
  console.log('moved with keyboard');
  ...
  switch (keyCode) {
    ...
    case 40:
      if (
        currentGameBoard[currentPlayer.rowLocation + 1][
          currentPlayer.colLocation
        ].staged
      ) {
        ...
        if (
          ...
          $(
            '#' + currentPlayer.rowLocation + '-' + currentPlayer.colLocation
          ).html('<img src =' + items.chest.image + '>');
        }
        currentPlayer.rowLocation++;
        if (
          currentPlayer.rowLocation === startingTileRow &&
          currentPlayer.colLocation === startingTileCol &&
          currentPlayer.gold >= 25
        ) {
        ...
        $(
          '#' + currentPlayer.rowLocation + '-' + currentPlayer.colLocation
        ).html('<img src=' + currentPlayer.image + '>');
        clearClickableSettings();
        setOnclickSettings();
        $('#deck').click(stageTiles);
      }
